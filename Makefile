...
tme1_exo2p2 : tme1_exo2p2.o fonctions_tableau.o fonctions_matrice.o
	gcc -Wall -o tme1_exo2p2 tme1_exo2p2.o fonctions_tableau.o fonctions_matrice.o
	
tme1_exo2p2.o : tme1_exo2p2.c fonctions_tableau.h fonctions_matrice.h
